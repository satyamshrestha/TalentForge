...
class AnswerService:
    ...
    def submit_answer(
        ...
        existing_answer = (
            self.answer_repository.get_answer_by_question_id(
                db,
                question_id
            )
        )
        ...
        answered_questions = sum(
            1
            for interview_question in interview.questions
            if interview_question.answer
        )
        ...
        self.interview_repository.update_interview_status(
            db,
            interview,
            status
        )
